<?php
ob_start();
define('API_KEY','269093808:AAEBMh_DLmIzDEaZIVkXi_4bNCnG2YCgB4Y');
$the_admin_id = 0;
...
//                }break;
                ...
                case '7':{
                    ...
                    if($image_id === false){
                        ...
                        $fule = 'https://api.telegram.org/file/bot269093808:AAEBMh_DLmIzDEaZIVkXi_4bNCnG2YCgB4Y/'.trim($imag->result->file_path,"\\/");
